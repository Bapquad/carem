...
function CyGame() {
	...
	function CreateGameLevel() {
		...
		Layer02.Text = new Carem.Text(Layer02);
		...
		/** Non-Filter Image */
		Layer02.Image00 = new Carem.Image(
			Layer02, 
		...
		Layer02.Image01 = new Carem.Image(
			Layer02, 
			canvasShaperAssetManager.getAsset("images/filter-sample.jpg")
		);
		...
		Layer02.Image02 = new Carem.Image(
			Layer02, 
			canvasShaperAssetManager.getAsset("images/filter-sample.jpg")
		);
		...
		Layer02.Image03 = new Carem.Image(
			Layer02, 
			canvasShaperAssetManager.getAsset("images/filter-sample.jpg")
		);
		...
		Layer02.Image04 = new Carem.Image(
			Layer02, 
			canvasShaperAssetManager.getAsset("images/filter-sample.jpg")
		);
		...
		Layer02.Image05 = new Carem.Image(
			Layer02, 
			canvasShaperAssetManager.getAsset("images/filter-sample.jpg")
		);
		...
		Layer03.Image01 = new Carem.Image(
			Layer03, 
			canvasShaperAssetManager.getAsset("images/filter-sample.jpg")
		);
		...
		Layer03.Image02 = new Carem.Image(
			Layer03, 
			canvasShaperAssetManager.getAsset("images/filter-sample.jpg")
		);
