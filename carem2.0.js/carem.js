...
Carem.Math = function() {}
Carem.Math.Min = function(value1, value2) 
{
	return (value1 < value2) ? value1 : value2;
};
Carem.Math.Max = function(value1, value2) 
{
	return (value1 < value2) ? value2 : value1;
};
Carem.Math.RadianFromAngle = function(Angle) 
{
	return Angle/360*2*Math.PI;
};
Carem.Math.AngleFromRadian = function(Ridian) 
{
	return Radian/2/Math.PI*360;
};
Carem.Math.VectorFromAngle = function(Angle) 
{
	return {x:Math.cos(Carem.Math.RadianFromAngle(Angle)), y:Math.sin(Carem.Math.RadianFromAngle(Angle))};
};
Carem.Math.VectorFromRadian = function(Radian) 
{
...
Carem.Math.intRandom = function(min, max) 
{
	return Math.floor(Carem.Math.Random(min, max));
};
...
Carem.Filter.getPixels = function(Image) 
{
...
Carem.Filter.getCanvas = function(Width, Height) 
{
...
Carem.Filter.FilterImage = function(Filter, image, var_args) 
{
...
Carem.AssetManager = function(ImageExtensionDesc, SoundExtensionDesc) {
	this.QueueType = [
...
Carem.SceneObject = function(context) 
{
	...
	this.UpdateScene = function(ratio) 
	{
		ratio = ratio || 1.0;
...
Carem.SymbolArc = function(Canvas) 
{
	...
	{
		this.setStrokeShape(0, join, thick);
		return;
	};
...
Carem.SymbolPolygon = function(Canvas) 
{
	...
	this.Draw = function(ratio) 
	{
		...
		var Radius = this.getScaleRatio()/2;
...
Carem.Image = function(Canvas, Asset) 
{
	...
	this.setStrokeWidth = function(width) 
	{
		this.__proto__.setStrokeWidth(width*2);
		return;
	};
