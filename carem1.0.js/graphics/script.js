...
function CyGame() {
	/** Create Layer */
	var Layer01 = new Carem_Layer("canvas_Slider");
	var Layer02 = new Carem_Layer("canvas_Slider");
	var Layer03 = new Carem_Layer("canvas_Slider2");
	var rot = 0.0;
	...
	Layer01.OrganBar = new Carem_SymbolRect(Layer01);
	...
	var canvasShaperAssetManager = new Carem_AssetManager("jpg|gif|png","wav|ogg|mp3");
	...
	function CreateGameLevel() {
		...
		Layer02.Flower1 = new Carem_SymbolRect(Layer02);
		...
		Layer02.RoundRect = new Carem_SymbolRoundRect(Layer02);
		...
		Layer02.Oval = new Carem_SymbolOval(Layer02);
		...
		Layer02.SliceOval = new Carem_SymbolArc(Layer02);
		...
		Layer02.Polygon = new Carem_SymbolPolygon(Layer02);
		...
		Layer02.Line = new Carem_SymbolLine(Layer02);
		...
		Layer02.Shape = new Carem_SymbolShape(Layer02);
		...
		Layer02.OrganBarStroke = new Carem_SymbolRect(Layer02);
		...
		Layer02.Text = new Carem_Text(Layer02);
		...
		/** Non-Filter Image */
		Layer02.Image00 = new Carem_Image(
			Layer02, 
		...
		Layer02.Image01 = new Carem_Image(
			Layer02, 
			canvasShaperAssetManager.getAsset("images/filter-sample.jpg")
		);
		...
		Layer02.Image01.setFilter(Carem_Filter.GrayScale);
		Layer02.Image01.setStrokeWidth(6);
		/** Brightness-Filter Image */
		Layer02.Image02 = new Carem_Image(
			Layer02, 
			canvasShaperAssetManager.getAsset("images/filter-sample.jpg")
		);
		...
		Layer02.Image02.setFilter(Carem_Filter.Brightness, 100);
		Layer02.Image02.setStrokeWidth(6);
		/** Threshold-Filter Image */
		Layer02.Image03 = new Carem_Image(
			Layer02, 
			canvasShaperAssetManager.getAsset("images/filter-sample.jpg")
		);
		...
		Layer02.Image03.setFilter(Carem_Filter.Threshold, 100);
		Layer02.Image03.setStrokeWidth(6);
		/** Sharpen with Convolute-Filter Image */
		Layer02.Image04 = new Carem_Image(
			Layer02, 
			canvasShaperAssetManager.getAsset("images/filter-sample.jpg")
		);
		...
		Layer02.Image05 = new Carem_Image(
			Layer02, 
			canvasShaperAssetManager.getAsset("images/filter-sample.jpg")
		);
		...
		Layer03.Text = new Carem_Text(Layer03);
		...
		Layer03.Image01 = new Carem_Image(
			Layer03, 
			canvasShaperAssetManager.getAsset("images/filter-sample.jpg")
		);
		...
		Layer03.Image01.setFilter(function(px) {
			px = Carem_Filter.GrayScale(px);
			var vertical = Carem_Filter.ConvoluteFloat32(
				px,
				[-1,-2,-1,
				0, 0, 0,
				1, 2, 1]
			);
			var horizontal = Carem_Filter.ConvoluteFloat32(
				px,
				[-1,0,1,
				-2,0,2,
				-1,0,1]
			);
			var id = Carem_Filter.createImageData(vertical.width, vertical.height);
		...
		Layer03.Image02 = new Carem_Image(
			Layer03, 
			canvasShaperAssetManager.getAsset("images/filter-sample.jpg")
		);
