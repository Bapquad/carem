...
{
	/** Create Layer */
	var Layer01 = new Carem_Layer("FishDemos");
	var Layer02 = new Carem_Layer("FishDemos");
	/** Settings Layer */
	Layer01.setBackground(255, 255, 255, 1);
	Layer02.setBackground(255, 150, 0, 1);
	/** Initialize the loading screen */
	Layer01.LoadingBar = new Carem_SymbolRect(Layer01);
	...
	var AssetManager = new Carem_AssetManager("jpg|gif|png", "wav|ogg|mp3");
	...
	function CreateFishLevel() 
	{
		...
		Layer02.Background = new Carem_StaticSprite(
			Layer02, 
			AssetManager.getAsset("images/background.jpg"), 
			0, 0, 480, 320
		);
		/** Create Scroller Wave */
		Layer02.Wave = new Carem_Scroller(Layer02, AssetManager.getAsset("images/wave.png"));
		...
		/** Create Play Button */
		Layer02.PlayButton = new Carem_Button(Layer02, AssetManager.getAsset("images/play.png"), 0, 0, 76, 32);
		...
		/** Create Static Fish */
		Layer02.Fish01 = new Carem_StaticSprite(Layer02, AssetManager.getAsset("images/fish.png"), 228, 18, 198, 114);
		Layer02.Fish01.Game_Streng = Carem_Math.intRandom(5, 30);
		...
		Layer02.Fish01.setWorldLimitTest(function(limit) 
		{
			...
			Layer02.Fish01.setScale(Layer02.Fish01.Game_Streng/100, Layer02.Fish01.Game_Streng/100);
			Layer02.Fish01.setCollisionBound(0, 0, 198*Layer02.Fish01.Game_Streng/100, 114*Layer02.Fish01.Game_Streng/100);
			Layer02.Fish01.setPositionY(Carem_Math.intRandom(25, 200));
			switch(limit) 
			{
				case CAREM_LIMIT_RIGHT:
					Layer02.Fish01.resetFlip(CAREM_FLIP_HORIZONTAL);
					Layer02.Fish01.setLinearVelocityX(Carem_Math.intRandom(-1, -5));
					break;
		...
		/** Create Animate Fish */
		Layer02.Fish02 = new Carem_AnimeSprite(Layer02, AssetManager.getAsset("images/fish1.png"), 198, 114);
		Layer02.Fish02.Game_Streng = Carem_Math.intRandom(5, 30);
		...
		Layer02.Fish02.setWorldLimitTest(function(Limit) 
		{
			...
			Layer02.Fish02.setScale(Layer02.Fish02.Game_Streng/100, Layer02.Fish02.Game_Streng/100);
			Layer02.Fish02.setCollisionBound(0, 0, 198*Layer02.Fish02.Game_Streng/100, 114*Layer02.Fish02.Game_Streng/100);
			Layer02.Fish02.setPositionY(Carem_Math.intRandom(25, 200));
			switch(Limit) 
			{
				case CAREM_LIMIT_RIGHT:
					Layer02.Fish02.setAction(Layer02.Fish02.Actions.Xuoi);
					Layer02.Fish02.setLinearVelocityX(Carem_Math.intRandom(-1, -5));
					break;
				case CAREM_LIMIT_LEFT:
		...
		/** Create Player Fish */
		Layer02.Player = new Carem_AnimeSprite(Layer02, AssetManager.getAsset("images/fish1.png"), 198, 114);
		...
		Layer02.Player.addCollisionTarget(Layer02.Fish01, function() 
		{
			if(Layer02.Fish01.Game_Streng < Layer02.Player.Game_Streng) 
			{
				...
				Layer02.Fish01.setPosition(-100, Carem_Math.intRandom(0, 240));
			}
			else 
			{
		...
		Layer02.Player.addCollisionTarget(Layer02.Fish02, function() 
		{
			if(Layer02.Fish02.Game_Streng < Layer02.Player.Game_Streng) 
			{
				...
				Layer02.Fish02.setPosition(-100, Carem_Math.intRandom(0, 240));
			}
			else 
			{
				Layer02.Player.Game_Over = 1;
		...
		Layer02.Bubble = new Carem_Particle(Layer02, AssetManager.getAsset("images/bubble.png"), 7);
		...
		/** Create Tile */
		Layer02.Tile = new Carem_Tile(Layer02);
