...
var CANVAS_SHAPER_PATH_ROUND_RECT = 1001;
var	CANVAS_SHAPER_PATH_CIRCLE = 1002;
var	CANVAS_SHAPER_PATH_OVAL = 1003;
var CANVAS_SHAPER_PATH_ARC = 1004;
var CANVAS_SHAPER_PATH_POLYGON = 1005;
var CANVAS_SHAPER_PATH_LINE = 1006;
var CANVAS_SHAPER_PATH_SHAPE = 1007;
var CANVAS_SHAPER_PATH_TEXT = 1008;
var CANVAS_SHAPER_ALIGN_TOP = 0;
var CANVAS_SHAPER_ALIGN_MIDDLE = "MIDDLE";
var CANVAS_SHAPER_ALIGN_BOTTOM = "BOTTOM";
var CANVAS_SHAPER_ALIGN_LEFT = 0;
var CANVAS_SHAPER_ALIGN_CENTER = "CENTER";
var CANVAS_SHAPER_ALIGN_RIGHT = "RIGHT";
var CANVAS_SHAPER_ORDER_LEFT = 0;
var CANVAS_SHAPER_ORDER_RIGHT = 1;
...
var CANVAS_SHAPER_REPEAT_X = "repeat-x";
var CANVAS_SHAPER_REPEAT_Y = "repeat-y";
var CANVAS_SHAPER_NO_REPEAT = "no-repeat";
var CANVAS_SHAPER_TEXT_BASELINE_TOP = "top";
var CANVAS_SHAPER_TEXT_BASELINE_BOTTOM = "bottom";
var CANVAS_SHAPER_TEXT_BASELINE_MIDDLE = "middle";
var CANVAS_SHAPER_TEXT_BASELINE_ALPHABETIC = "alphabetic";
var CANVAS_SHAPER_TEXT_BASELINE_HANGING = "hanging";
var CANVAS_SHAPER_TEXT_ALIGN_START = "start";
var CANVAS_SHAPER_TEXT_ALIGN_END = "end";
var CANVAS_SHAPER_TEXT_ALIGN_LEFT = "left";
var CANVAS_SHAPER_TEXT_ALIGN_CENTER = "center";
var CANVAS_SHAPER_TEXT_ALIGN_RIGHT = "right";
var CANVAS_SHAPER_GLOBAL_CO_SRCOVER = "source-over";
var CANVAS_SHAPER_GLOBAL_CO_SRCATOP = "source-atop";
var CANVAS_SHAPER_GLOBAL_CO_SRCIN = "source-in";
var CANVAS_SHAPER_GLOBAL_CO_SRCOUT = "source-out";
var CANVAS_SHAPER_GLOBAL_CO_DESTOVER = "destination-over";
var CANVAS_SHAPER_GLOBAL_CO_DESTATOP = "destination-atop";
var CANVAS_SHAPER_GLOBAL_CO_DESTIN = "destination-in";
var CANVAS_SHAPER_GLOBAL_CO_DESTOUT = "destination-out";
var CANVAS_SHAPER_GLOBAL_CO_LIGHTER = "lighter";
var CANVAS_SHAPER_GLOBAL_CO_COPY = "copy";
var CANVAS_SHAPER_GLOBAL_CO_XOR = "xor";
var CANVAS_SHAPER_FLIP_HORIZONTAL = 0;
var CANVAS_SHAPER_FLIP_VERTICLE = 1;
var CANVAS_SHAPER_LIMIT_OFF = 0;
var CANVAS_SHAPER_LIMIT_NULL = 1;
var CANVAS_SHAPER_LIMIT_CLAMP = 2;
var CANVAS_SHAPER_LIMIT_BOUNCE = 3;
var CANVAS_SHAPER_LIMIT_STICKY = 4;
var CANVAS_SHADER_LIMIT_KILL = 5;
var CANVAS_SHAPER_LIMIT_LEFT = 0;
var CANVAS_SHAPER_LIMIT_TOP = 1;
var CANVAS_SHAPER_LIMIT_RIGHT = 2;
var CANVAS_SHAPER_LIMIT_BOTTOM = 3;
var CANVAS_SHAPER_HORIZONTAL = 0;
var CANVAS_SHAPER_VERTICLE = 1;
var CANVAS_SHAPER_LOOP_KILL = 0;
var CANVAS_SHAPER_LOOP_CYCLE = 1;
var CANVAS_SHAPER_COLLISION_RECT = 0;
var CANVAS_SHAPER_COLLISION_RAD = 1;
...
var CanvasShaper_Filter = function() {};
...
CanvasShaper_Filter.Convolute = function(pixels, weights, opaque) {
	...
	var w = sw;
	var h = sh;
	var output = CanvasShaper_Filter.createImageData(w, h);
	var dst = output.data;
...
var CanvasShaper_AssetManager = function(ImageExtensionDesc, SoundExtensionDesc) {
	this.QueueType = [
...
var CanvasShaper_Graphics = function(context) {
	...
	this.alpha = 1.0;
	this.composite = CANVAS_SHAPER_GLOBAL_CO_SRCOVER;
	this.clip = false;
	this.save = false;
	this.restore = false;
	...
	this.flip = function(mode) {
		switch(mode) {
			case CANVAS_SHAPER_FLIP_HORIZONTAL:
				this.hScaleMode *= -1;
				break;
			case CANVAS_SHAPER_FLIP_VERTICLE:
				this.vScaleMode *= -1;
				break;
			default:
				break;
...
var CanvasShaper_SymbolArc = function(Canvas) {
	...
	/** Graphics Section */
	this.Graphics = new CanvasShaper_Graphics(this.context);
	/** SceneObject Section */
	...
	this.setCircleSlice = function(startAngle, endAngle) {
		...
		this.sliceAngleToDraw = CanvasShaper_Math.RadianFromAngle(360-endAngle);
		return;
	};
...
var CanvasShaper_SymbolShape = function(Canvas) {
	...
	this.Graphics = new CanvasShaper_Graphics(this.context);
	/** SceneObject Section */
	this.SceneObject = new CanvasShaper_SceneObject(Canvas.getContext());
...
var CanvasShaper_Text = function(Canvas) {
	...
	this.fontName = "Arial";
	this.fontSize = 12;
	this.textBaseline = CANVAS_SHAPER_TEXT_BASELINE_ALPHABETIC;
